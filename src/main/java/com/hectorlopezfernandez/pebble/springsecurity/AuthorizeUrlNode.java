...
public class AuthorizeUrlNode extends AbstractRenderableNode {
    ...
    public AuthorizeUrlNode(int lineNumber, Expression<?> urlExpression, Expression<?> methodExpression,
                            BodyNode body, BodyNode elseBody) {
        super(lineNumber);
    ...
    public void render(PebbleTemplateImpl self, Writer writer,
                       EvaluationContextImpl context) throws PebbleException, IOException {
    	...
    	if (SecurityContextHolder.getContext() != null) {
    		...
    		if (!(evaluatedUrl instanceof String)) {
    			throw new IllegalArgumentException("AuthorizeUrl block only supports String urls. Actual argument " +
                    "was: " + (evaluatedUrl == null ? "null" : evaluatedUrl.getClass().getName()));
    		}
    		...
    		if (!(evaluatedMethod instanceof String)) {
    			throw new IllegalArgumentException("AuthorizeUrl block only supports String methods. Actual argument " +
                    "was: " + (evaluatedMethod == null ? "null" : evaluatedMethod.getClass().getName()));
    		}
